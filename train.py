...
parser.add_argument('-taskname', type=str, default="all-mix",
                    help='name of the task')
parser.add_argument('-gpus', nargs='+', type=str, default=None,
                    help='available GPUs')
parser.add_argument('-train', type=str,  default=None,
                    help='train file', required=True)
parser.add_argument('-val', type=str, default=None,
                    help='val file', required=True)
...
create_registry(args.dir, args.train, args.val, args.taskname, args.compression, args.storemode)
